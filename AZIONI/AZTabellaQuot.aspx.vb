...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim zx As Int16 = 0
        Dim zy As Int16 = 0
        'Dim sql = "SELECT * FROM QUOTAZIONI WHERE ISINCODE = '" & Session("ISINCODE") & "' AND ANNO = '" & Session("QUOTANNO") & "'"
        Dim sql = "SELECT MESE, CAST(COMPENSO AS decimal(10,4)) as COMP1,CAST(MINIMO AS decimal(10,4)) as MIN1,CAST(MASSIMO AS decimal(10,4)) as MAX1 FROM QUOTAZIONI WHERE ISINCODE = '" & Session("ISINCODE") & "' AND ANNO = '" & Session("QUOTANNO") & "'"
