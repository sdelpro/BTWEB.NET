<%@ Page Language="vb" AutoEventWireup="false" Codebehind="AZDettWarr.aspx.vb" Inherits="BTWEB.NET.AZDettWarr"%>
...
<HTML>
	...
	<body background="..\Images\sfMenuidx.jpg" MS_POSITIONING="GridLayout" bottomMargin="0"
		...
		<FORM id="Form1" method="post" runat="server">
			<asp:table id="tbAss" style="Z-INDEX: 103; LEFT: 0px; POSITION: absolute; TOP: 136px" runat="server"
				...
				<asp:TableRow Font-Size="12px" Font-Names="Tahoma">
					...
					<asp:TableCell Width="16.7%"></asp:TableCell>
					<asp:TableCell Width="16.7%"></asp:TableCell>
				</asp:TableRow>
				<asp:TableRow Font-Size="12px" Font-Names="Tahoma">
					<asp:TableCell BorderStyle="Solid" BorderWidth="1px" BackColor="Gainsboro" BorderColor="Black"></asp:TableCell>
