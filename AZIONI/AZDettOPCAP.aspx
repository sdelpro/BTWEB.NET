<%@ Page Language="vb" AutoEventWireup="false" Codebehind="AZDettOPCAP.aspx.vb" Inherits="BTWEB.NET.AZDettOPCAP"%>
...
<HTML>
	...
	<body>
		<FORM id="Form1" method="post" runat="server">
						...
						<div id="contenuto">
							<div id="due-colonne">
								<table>
									...
									<tr>
										<td><span class="etichetta">INIZIO</span>
											<asp:label id="lbl_inizio" runat="server" cssclass="valore"></asp:label></td>
										<td class="separa"></td>
										<td><span class="etichetta">FINE</span>
											<asp:label id="lbl_fine" runat="server" cssclass="valore"></asp:label></td>
									</tr>
									<tr>
										<td><span class="etichetta">STORICIZZAZIONE%</span>
											<asp:label id="lbl_storic" runat="server" cssclass="valore"></asp:label></td>
									</tr>
									<tr>
										<td><span class="etichetta">OPERAZIONI SUL CAPITALE - TESTO COMPLETO DELL'OPERAZIONE</span>
											<asp:label id="lbl_operaz" runat="server" cssclass="valore"></asp:label></td>
									</tr>
									<tr>
										<td><span class="etichetta">TABELLA DI PARITA'</span>
											<asp:label id="lbl_parita" runat="server" cssclass="valore"></asp:label></td>
									</tr>
								</table>
								<div class="clear"></div>
							</div>
			...
			<asp:table id="tbOp" style="Z-INDEX: 103; LEFT: 0px; POSITION: absolute; TOP: 136px" runat="server"
				Width="100%" Height="20px">
				<asp:TableRow Width="100%" BorderWidth="1px" Font-Size="12px" Font-Names="Tahoma">
					<asp:TableCell BorderStyle="Solid" BorderWidth="1px" BackColor="Gainsboro" Width="12.5%" Font-Size="12px"
					...
					<asp:TableCell BorderStyle="Solid" BorderWidth="1px" BackColor="Transparent" ColumnSpan="5" Width="62.5%"
						BorderColor="Black"></asp:TableCell>
				</asp:TableRow>
				<asp:TableRow Width="100%">
					<asp:TableCell BorderStyle="Solid" BorderWidth="1px" BackColor="Gainsboro" Width="12.5%" Font-Size="12px"
						Font-Names="Tahoma" BorderColor="Black"></asp:TableCell>
					<asp:TableCell BorderStyle="Solid" BorderWidth="1px" BackColor="Transparent" Width="12.5%" Font-Size="12px"
						Font-Names="Tahoma" BorderColor="Black"></asp:TableCell>
					<asp:TableCell BorderStyle="Solid" BorderWidth="1px" BackColor="Gainsboro" Width="12.5%" Font-Size="12px"
						Font-Names="Tahoma" BorderColor="Black"></asp:TableCell>
					<asp:TableCell BorderStyle="Solid" BorderWidth="1px" BackColor="Transparent" Width="12.5%" Font-Size="12px"
				...
				<asp:TableRow Font-Size="12px" Font-Names="Tahoma">
					<asp:TableCell BorderStyle="Solid" BorderWidth="1px" BackColor="Gainsboro" ColumnSpan="8" BorderColor="Black"></asp:TableCell>
				</asp:TableRow>
				<asp:TableRow>
					<asp:TableCell BorderStyle="Solid" BorderWidth="1px" BackColor="Transparent" ColumnSpan="8" Font-Size="12px"
						Font-Names="Tahoma" BorderColor="Black"></asp:TableCell>
				</asp:TableRow>
				<asp:TableRow Font-Size="12px" Font-Names="Tahoma">
					<asp:TableCell BorderStyle="Solid" BorderWidth="1px" BackColor="Gainsboro" ColumnSpan="8" BorderColor="Black"></asp:TableCell>
