						...
						<div id="contenuto">
							<table>
								...
								<tr>
									...
									<td><asp:textbox CssClass="datepicker"  id="txtDtMDa" runat="server" tabIndex="3" placeholder="Da"></asp:textbox></td>
									<td><asp:textbox CssClass="datepicker"  id="txtDtMA" style="Z-INDEX: 109" runat="server" tabIndex="4" placeholder="A"></asp:textbox></td>
								</tr>
								<tr class="note">
									<td></td>
