						...
						<div id="contenuto">
							<table>
								...
								<tr>
									...
									<td><asp:textbox id="txtNota" style="Z-INDEX: 123" runat="server" tabIndex="4"></asp:textbox></td>
								</tr>
								<tr>
									<td></td>
									<td colspan="2">
							...
							<div id="box-interna">
								<ul>
									...
									<li>
										<asp:label id="lbHelp2" style="Z-INDEX: 120" runat="server">• Selezionando il warrant desiderato si accede alla consultazione della Tabella warrant.</asp:label></li>
									<li>
										<asp:label id="lbHelp1" style="Z-INDEX: 105" runat="server">• La ricerca per WARRANT può essere effettuata per descrizione (anche solo parte del nome), per codice ISIN o UIC, per condizioni di esercizio, per periodo di esercizio; per ottenere l’elenco di TUTTI I WARRANT basta premere il pulsante "Ricerca" senza avere effettuato alcun’altra selezione.</asp:label></li></ul>
							</div>
							<div>
							...
							<div>
								...
								<asp:textbox id="txtDtMA" style="Z-INDEX: 109" runat="server" Visible="False"></asp:textbox>
								<asp:textbox id="txtDtMDa" style="Z-INDEX: 108" runat="server" Visible="False"></asp:textbox>
