...
#End Region
        ...
        Private Sub CreateMenuRicercheObbligazioni(ByVal _PathImage As String)
            ...
            m_strScriptMenu += " stm_aix(""p1i3"",""p1i0"",[0,""Cedole per Data Scadenza"","""","""",-1,-1,0,""OBFindCedScad.aspx"",""_self"","""",""Ricerca delle cedole per data scadenza""]);" & vbCrLf
            ...
            m_strScriptMenu += " stm_aix(""p1i5"",""p1i0"",[0,""News Obbligazioni"","""","""",-1,-1,0,""OBFindNews.aspx"",""_self"","""",""Ricerca news obbligazioni""]);" & vbCrLf
        ...
        Private Sub CreateMenuRicercheAzioni(ByVal _PathImage As String)
            ...
            m_strScriptMenu += " stm_aix(""p1i3"",""p1i0"",[0,""CDA"","""","""",-1,-1,0,""AZFindCDA.aspx"",""_self"","""",""Ricerca dei CDA per data""]);" & vbCrLf
            m_strScriptMenu += " stm_aix(""p1i4"",""p1i0"",[0,""Dividendi"","""","""",-1,-1,0,""AZFindDIV.aspx"",""_self"","""",""Ricerca dividendi per stato per data""]);" & vbCrLf
            m_strScriptMenu += " stm_aix(""p1i5"",""p1i0"",[0,""News Azioni"","""","""",-1,-1,0,""AZFindNEWS.aspx"",""_self"","""",""Ricerca News Società""]);" & vbCrLf
            m_strScriptMenu += " stm_aix(""p1i6"",""p1i5"",[0,""Azioni Convertibili"","""","""",-1,-1,0,""AZFindCONV.aspx"",""_self"","""",""Ricerca Covertibili in Corso""]);" & vbCrLf
            m_strScriptMenu += " stm_aix(""p1i7"",""p1i5"",[0,""Operazioni sul Capitale"","""","""",-1,-1,0,""AZFindOPCAP.aspx"",""_self"","""",""Ricerca Op. sul Capitale""]);" & vbCrLf
            m_strScriptMenu += " stm_aix(""p1i8"",""p1i0"",[0,""Tabella Warrant in circolazione"","""","""",-1,-1,0,""AZFindWARR.aspx"",""_self"","""",""Ricerca warrant""]);" & vbCrLf
            m_strScriptMenu += " stm_aix(""p1i9"",""p1i5"",[0,""Quotazioni"","""","""",-1,-1,0,""AZFindQuot.aspx"",""_self"","""",""Ricerca quotazioni titolo""]);" & vbCrLf
            'm_strScriptMenu += " stm_aix(""p1i10"",""p1i5"",[0,""Obbligazioni estratte""]);" & vbCrLf
            m_strScriptMenu += " stm_ep();" & vbCrLf
            m_strScriptMenu += " stm_ep();" & vbCrLf
            m_strScriptMenu += " stm_em();" & vbCrLf
