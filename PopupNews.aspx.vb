...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Session("LOGIN_VALIDATE") = "ABILITATO_BT" Then
            ...
            Dim zx As Integer = 0
            Dim sql As String = "SELECT NEWS FROM NEWSGENERALI WHERE IDNEWS = " & CType(parIDNEWS, Double)
            With clt
                Call .ReadGenericQuery(dt, sql)
                If dt.Rows.Count > 0 Then
                    'tbNews.Rows(0).Cells(0).Text() = Replace(dt.Rows(0).Item("NEWS"), Chr(13), "<br>")
                    tbNews.Rows(0).Cells(0).Text() = Replace(Replace(dt.Rows(0).Item("NEWS"), Chr(13), "<br>"), "  ", "&nbsp;&nbsp;")
                End If
                .Dispose()
            End With
        Else
