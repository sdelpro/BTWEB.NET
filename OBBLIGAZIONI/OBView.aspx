	...
	<body bottomMargin="0" bgColor="white" leftMargin="0" background="..\Images\sfMenuidx.jpg"
		...
		<asp:table id="tbCarPrinc" style="Z-INDEX: 100; LEFT: 0px; POSITION: absolute; TOP: 136px"
			...
			<asp:TableRow Font-Size="12px" Font-Names="Tahoma">
				...
				<asp:TableCell BorderStyle="Solid" BorderWidth="1px" BackColor="Gainsboro" ColumnSpan="4" Width="25%"
					BorderColor="Black"></asp:TableCell>
				<asp:TableCell BorderStyle="Solid" BorderWidth="0px" BackColor="Transparent" RowSpan="2" ColumnSpan="1"
					Width="12.5%" BorderColor="Black"></asp:TableCell>
				<asp:TableCell BorderStyle="Solid" BorderWidth="0px" BackColor="Transparent" RowSpan="2" ColumnSpan="1"
					Width="12.5%" BorderColor="Black"></asp:TableCell>
				<asp:TableCell BorderStyle="Solid" BorderWidth="0px" BackColor="Transparent" RowSpan="2" ColumnSpan="1"
					Width="12.5%" BorderColor="Black"></asp:TableCell>
			...
			<asp:TableRow Font-Size="12px" Font-Names="Tahoma">
				<asp:TableCell BorderStyle="Solid" BorderWidth="1px" BackColor="Transparent" ColumnSpan="1" Width="12.5%"
					BorderColor="Black"></asp:TableCell>
				<asp:TableCell BorderStyle="Solid" BorderWidth="1px" BackColor="Transparent" ColumnSpan="4" Width="25%"
					BorderColor="Black"></asp:TableCell>
			</asp:TableRow>
			<asp:TableRow Font-Size="12px" Font-Names="Tahoma">
			...
			<asp:TableRow Font-Size="12px" Font-Names="Tahoma">
				<asp:TableCell BorderWidth="1px" BackColor="Gainsboro" Width="12.5%" BorderColor="Transparent"></asp:TableCell>
				<asp:TableCell BorderWidth="1px" BackColor="Transparent" Width="12.5%" HorizontalAlign="Right"
					BorderColor="Transparent"></asp:TableCell>
				<asp:TableCell BorderStyle="Solid" BorderWidth="1px" BackColor="Gainsboro" Width="12.5%" BorderColor="Black"></asp:TableCell>
				<asp:TableCell BorderStyle="Solid" BorderWidth="1px" Width="12.5%" HorizontalAlign="Right" BorderColor="Black"></asp:TableCell>
				<asp:TableCell BorderStyle="Solid" BorderWidth="1px" BackColor="Gainsboro" Width="12.5%" BorderColor="Black"></asp:TableCell>
				<asp:TableCell BorderStyle="Solid" BorderWidth="1px" Width="12.5%" HorizontalAlign="Right" BorderColor="Black"></asp:TableCell>
				<asp:TableCell BorderStyle="Solid" BorderWidth="1px" BackColor="Gainsboro" Width="12.5%" BorderColor="Black"></asp:TableCell>
				<asp:TableCell BorderStyle="Ridge" BorderWidth="1px" Width="12.5%" HorizontalAlign="Right" BorderColor="Black"></asp:TableCell>
			</asp:TableRow>
			<asp:TableRow Font-Size="12px" Font-Names="Tahoma">
				<asp:TableCell BorderStyle="Solid" BorderWidth="1px" BackColor="Gainsboro" Width="12.5%" BorderColor="Black"></asp:TableCell>
			...
			<asp:TableRow Font-Size="12px" Font-Names="Tahoma">
				<asp:TableCell BorderStyle="Solid" BorderWidth="0px" BackColor="Transparent" Width="12.5%" BorderColor="Black"></asp:TableCell>
				<asp:TableCell BorderStyle="Solid" BorderWidth="0px" BackColor="Transparent" Width="12.5%" HorizontalAlign="Right"
					BorderColor="Black"></asp:TableCell>
				<asp:TableCell BorderStyle="Solid" BorderWidth="1px" BackColor="Gainsboro" Width="12.5%" BorderColor="Black"></asp:TableCell>
				<asp:TableCell BorderStyle="Solid" BorderWidth="1px" Width="12.5%" HorizontalAlign="Right" BorderColor="Black"></asp:TableCell>
				<asp:TableCell BorderStyle="Solid" BorderWidth="1px" BackColor="Gainsboro" Width="12.5%" BorderColor="Black"></asp:TableCell>
			...
			<asp:TableRow Font-Size="12px" Font-Names="Tahoma">
				<asp:TableCell BackColor="White" Width="12.5%" BorderColor="White"></asp:TableCell>
				<asp:TableCell BackColor="White" Width="12.5%" HorizontalAlign="Right" BorderColor="White"></asp:TableCell>
				<asp:TableCell BorderStyle="Solid" BorderWidth="1px" BackColor="Gainsboro" Width="12.5%" BorderColor="Black"></asp:TableCell>
				<asp:TableCell BorderStyle="Solid" BorderWidth="1px" Width="12.5%" HorizontalAlign="Right" BorderColor="Black"></asp:TableCell>
				<asp:TableCell BorderStyle="Solid" BorderWidth="1px" BackColor="Gainsboro" Width="12.5%" BorderColor="Black"></asp:TableCell>
				<asp:TableCell BorderStyle="Solid" BorderWidth="1px" Width="12.5%" HorizontalAlign="Right" BorderColor="Black"></asp:TableCell>
			...
			<asp:TableRow Font-Size="12px" Font-Names="Tahoma">
				<asp:TableCell BorderStyle="Solid" BorderWidth="1px" BackColor="Gainsboro" ColumnSpan="2" Width="25%"
					BorderColor="Black"></asp:TableCell>
				<asp:TableCell BorderStyle="Solid" BorderWidth="1px" BackColor="Transparent" ColumnSpan="4" Width="360px"
					BorderColor="Black"></asp:TableCell>
			</asp:TableRow>
			<asp:TableRow Font-Size="12px" Font-Names="Tahoma">
				<asp:TableCell BackColor="Transparent" ColumnSpan="8" Width="100%" BorderColor="Black"></asp:TableCell>
		...
		<asp:label id="lblLastLogin" style="Z-INDEX: 104; LEFT: 6px; POSITION: absolute; TOP: 80px"
			runat="server" Font-Size="12px" Font-Names="Tahoma" Height="16px" Width="337px" BackColor="Transparent">Ultima connessione</asp:label><asp:image id="Image1" style="Z-INDEX: 102; LEFT: 8px; POSITION: absolute; TOP: 32px" runat="server"
			Height="44px" Width="352px" ImageUrl="..\Images\Logo.gif"></asp:image>
		<TABLE id="Table1" style="Z-INDEX: 101; LEFT: 4px; POSITION: absolute; TOP: 99px" cellSpacing="0"
			cols="2" cellPadding="0" width="100%" border="0">
			<TR>
				<TD><ucmenu:dhtmlmenucontrol id="Dhtmlmenucontrol3" runat="server" TypeMenu="RicercheObbligazioni" ImagePath="../Images/"></ucmenu:dhtmlmenucontrol>
					<asp:label id="lblTIPORICERCA" Width="288px" Height="16px" Font-Names="Tahoma" Font-Size="12px"
						runat="server" BackColor="Transparent" Font-Bold="True" ForeColor="Lime">TIPO RICERCA EFFETTUATA</asp:label></TD>
				<TD style="HEIGHT: 30px" align="right"><ucmenu:dhtmlmenucontrol id="DHTMLMenuControl1" runat="server" TypeMenu="Obbligazioni" ImagePath="../Images/"></ucmenu:dhtmlmenucontrol></TD>
			</TR>
		</TABLE>
	</body>
</HTML>
