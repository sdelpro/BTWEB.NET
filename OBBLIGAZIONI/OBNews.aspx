...
<HTML>
	...
	<body bottomMargin="0" bgColor="white" leftMargin="0" background="..\Images\sfMenuidx.jpg"
		...
		<asp:table id="tbCarPrinc" style="Z-INDEX: 100; LEFT: 0px; POSITION: absolute; TOP: 136px"
			Width="100%" Height="57" Font-Names="Tahoma" Font-Size="14px" runat="server">
		...
		<TABLE id="Table2" style="Z-INDEX: 105; LEFT: 3px; WIDTH: 962px; POSITION: absolute; TOP: -2px; HEIGHT: 8px"
		...
		<asp:image id="Image1" style="Z-INDEX: 104; LEFT: 4px; POSITION: absolute; TOP: 32px" Width="352px"
			Height="44px" runat="server" ImageUrl="..\Images\Logo.gif"></asp:image><asp:label id="lblLastLogin" style="Z-INDEX: 103; LEFT: 8px; POSITION: absolute; TOP: 80px"
			Width="360px" Height="16px" Font-Names="Tahoma" Font-Size="12px" runat="server" BackColor="Transparent">Ultima connessione</asp:label>
		<TABLE id="Table1" style="Z-INDEX: 101; LEFT: 8px; POSITION: absolute; TOP: 100px" cellSpacing="0"
			cols="2" cellPadding="0" width="98%" border="0">
			<TR>
				<TD><ucmenu:dhtmlmenucontrol id="Dhtmlmenucontrol3" runat="server" ImagePath="../Images/" TypeMenu="RicercheObbligazioni"></ucmenu:dhtmlmenucontrol>
