...
<HTML>
	<HEAD>
		...
		<LINK rel="stylesheet" type="text/css" href="../css/style.css"><link rel="stylesheet" href="../css/jquery-ui.css"><script src="../js//jquery-1.10.2.js"></script><script src="../js/jquery-ui.js"></script><script>$(function() {$.datepicker.setDefaults($.datepicker.regional['it']); $(".datepicker").datepicker(); $(".datepicker").datepicker("option", "dateFormat", "dd/mm/yy");	});	</script>	</HEAD>
	<body>
			...
			<div id="riga-pagina">
				<div id="pagina">
					<div id="interna">
						...
						<div id="contenuto">
							<asp:table id="tbCarPrinc" Width="100%" class="quattro-colonne" runat="server">
								<asp:TableRow>
								...
								<asp:TableRow>
									...
									<asp:TableCell class="etichetta" ColumnSpan="2" Width="25%"></asp:TableCell>
									<asp:TableCell class="etichetta" ColumnSpan="4" Width="50%"></asp:TableCell>
								</asp:TableRow>
							</asp:table>
							<asp:label id="lblNoRecord"	runat="server" Visible="False">Nessuna maggiorazione trovata</asp:label>
							</TABLE>
						</div>
					</div>
				</div>
