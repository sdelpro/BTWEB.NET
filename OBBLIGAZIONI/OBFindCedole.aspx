	...
	<body bgProperties="fixed" background="..\Images\sfHome.jpg" MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			...
			<asp:label id="Label14" style="Z-INDEX: 120; LEFT: 312px; POSITION: absolute; TOP: 616px" runat="server"
				...
				ForeColor="Black" Font-Names="Tahoma" Font-Size="8pt" BackColor="Transparent" Width="136px" Height="16px" Visible="False">DATA SCADENZA CEDOLE (GG/MM/AAAA)</asp:label><asp:textbox id="txtDtScA" style="Z-INDEX: 117; LEFT: 328px; POSITION: absolute; TOP: 608px"
				tabIndex="5" runat="server" Width="85px" Height="20px" BorderStyle="Groove" Visible="False"></asp:textbox><asp:textbox id="txtDtScDa" style="Z-INDEX: 116; LEFT: 208px; POSITION: absolute; TOP: 608px"
				...
				ForeColor="Black" Font-Names="Tahoma" Font-Size="8pt" BackColor="Transparent" Width="24px" Height="16px">DA</asp:label><asp:textbox id="txtDtMA" style="Z-INDEX: 112; LEFT: 320px; POSITION: absolute; TOP: 320px" tabIndex="6"
				runat="server" Width="85px" Height="20px" BorderStyle="Groove"></asp:textbox><asp:textbox id="txtDtMDa" style="Z-INDEX: 111; LEFT: 200px; POSITION: absolute; TOP: 320px"
				...
				ForeColor="Black" Font-Names="Tahoma" Font-Size="8pt" BackColor="Transparent" Width="12px" Height="16px" Visible="False">A</asp:label><asp:textbox id="txtDtInA" style="Z-INDEX: 109; LEFT: 328px; POSITION: absolute; TOP: 656px"
				tabIndex="8" runat="server" Width="85px" Height="20px" BorderStyle="Groove" Visible="False"></asp:textbox><asp:textbox id="txtDtInDa" style="Z-INDEX: 104; LEFT: 208px; POSITION: absolute; TOP: 656px"
